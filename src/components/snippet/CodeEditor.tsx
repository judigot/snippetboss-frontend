    ...
    >
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }}>
        <div
          role="button"
          style={
            activeTab === TRANSFORM_OPTIONS.DEFAULT ? activeTabStyle : tabStyle
          }
        ...
        <div
          role="button"
          style={
            activeTab === TRANSFORM_OPTIONS.VS_CODE ? activeTabStyle : tabStyle
          }
        ...
        <div
          role="button"
          style={
            activeTab === TRANSFORM_OPTIONS.RAW_CODE ? activeTabStyle : tabStyle
          }
